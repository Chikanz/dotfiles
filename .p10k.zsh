# Generated by Powerlevel10k configuration wizard on 2023-08-26 at 12:50 AEST.
...
prompt_custom_icon() {
  echo wassup
  local color='%F{208}'  # Orange color
  p10k segment -i '🚀' -f 208
}
...
local color='%F{white}'  # White color
    p10k segment -b 1 -f 3 -i '👽'
  }
